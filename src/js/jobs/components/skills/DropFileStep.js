...
export default class DropFileScreen extends React.Component {
    ...
    render() {
        ...
        if (this.props.hasFile) {
            ...
            dragAndDrop = (
                <DropZone ref={(node) => { this.dropzone = node; }} onDrop={this.props.onDrop} multiple={false} accept="application/pdf" activeStyle={style.activeDropZone} className="dragAndDropArea hidden-xs" maxSize={2000000}>
